...
class MainWidget(RelativeLayout):
    ...
    def init_audio(self):
        self.begin_sound = SoundLoader.load('begin.wav')
        self.galaxy_sound = SoundLoader.load('galaxy.wav')
        self.game_over_impact_sound = SoundLoader.load('gameover_impact.wav')
        self.game_over_voice_sound = SoundLoader.load('gameover_voice.wav')
        self.music_sound = SoundLoader.load('music1.wav')
        self.restart_sound = SoundLoader.load('restart.wav')
        self.begin_sound.volume =0.25
        self.music_sound.volume =1
        self.restart_sound.volume =0.25
        self.game_over_voice_sound.volume =0.25
        self.galaxy_sound.volume =0.25
        self.game_over_impact_sound.volume =0.6
    ...
    def on_touch_down(self, touch):
        ...
        if self.game_start_state and not self.game_over_state:
